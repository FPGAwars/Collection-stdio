{
  "version": "1.2",
  "package": {
    "name": "Print-bin-4-bits",
    "version": "0.1",
    "description": "Print a 4-bits number in Binary",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "83ac48c8-e79b-409f-b3e2-2f121eecfc8c",
          "type": "basic.input",
          "data": {
            "name": "n",
            "range": "[3:0]",
        ...
        {
          "id": "7a02d44d-7ce7-4ebb-a552-bf42b971ec93",
          "type": "basic.inputLabel",
          "data": {
            "name": "n",
            "range": "[3:0]",
        ...
        {
          "id": "9e5064a3-319b-41ce-bb99-0947ef5fe7b9",
          "type": "basic.outputLabel",
          "data": {
            "name": "n",
            "range": "[3:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Print-bin-4-bits: Transmit one 4-bits number in Binary\n\nWhen activated, the 4-bits number is sent as three binary  \ncharacters (0/1)",
            "readonly": true
          },
          "position": {
            "x": -112,
        ...
        {
          "id": "dbd3fefd-4b42-4629-82c9-baffc65dc30b",
        ...
        {
          "id": "2a887204-bd96-4934-8012-d7d9c0284ecb",
          "type": "a6f62ac1352354befb6378f21afefafac84a32db",
          "position": {
            "x": 504,
            "y": 288
          },
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "dbd3fefd-4b42-4629-82c9-baffc65dc30b",
        ...
        },
        {
          ...
          "target": {
            "block": "2a887204-bd96-4934-8012-d7d9c0284ecb",
        ...
        {
          "source": {
            "block": "83ac48c8-e79b-409f-b3e2-2f121eecfc8c",
            "port": "out",
            "size": 4
          },
          "target": {
            "block": "7a02d44d-7ce7-4ebb-a552-bf42b971ec93",
            "port": "inlabel"
          },
          "size": 4
        },
        {
          "source": {
            "block": "9e5064a3-319b-41ce-bb99-0947ef5fe7b9",
            "port": "outlabel"
          },
          "target": {
            "block": "2a887204-bd96-4934-8012-d7d9c0284ecb",
            "port": "5998ec19-959b-42d4-94e2-1e7b21c95888",
            "size": 4
          },
          "vertices": [
            {
  ...
  "dependencies": {
    ...
    "a6f62ac1352354befb6378f21afefafac84a32db": {
      "package": {
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "5998ec19-959b-42d4-94e2-1e7b21c95888",
              "type": "basic.input",
              "data": {
                "name": "d",
                "range": "[3:0]",
            ...
            {
              "id": "13895566-f649-4948-a068-3be6b4c7c02e",
              "type": "basic.output",
              "data": {
                "name": "q",
                "range": "[3:0]",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "5998ec19-959b-42d4-94e2-1e7b21c95888",
                "port": "out"
              },
              "target": {
                "block": "db9bff83-fad6-439b-8d86-89e21ad7870d",
            ...
            },
            {
              ...
              "target": {
                "block": "13895566-f649-4948-a068-3be6b4c7c02e",
                "port": "in"
              },
              "size": 4
            }
